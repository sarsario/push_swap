...
OBJ_DIRS = $(VLD) $(STACK) $(ALGO)
SRCS = $(VLD)/ft_is_int.c $(VLD)/ft_parse.c $(STACK)/ft_stack.c\
	...
	$(ALGO)/efficient_move2.c $(ALGO)/efficient_move.c $(ALGO)/lis_sort.c\
	$(ALGO)/ft_sort.c push_swap.c
OBJ_DIR = obj
